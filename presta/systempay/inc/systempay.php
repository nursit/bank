...
function systempay_signe_contexte($contexte, $key, $algorithm = 'sha1'){return payzen_signe_contexte($contexte, $key, $algorithm);}
function systempay_verifie_signature($values, $key, $algorithm = 'sha1'){return payzen_verifie_signature($values, $key, $algorithm);}
